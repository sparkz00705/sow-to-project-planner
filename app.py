...
def main() -> None:
    ...
    # Visitor counter is intentionally reset to a clean baseline for this release.
    # No external counter is called, so an old accumulated value cannot leak into the UI.
